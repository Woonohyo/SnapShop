...
/**
 * {@code PullToRefreshNode} has an information in contents of
 * pulltorefresh.xml, <br />
...
class PullToRefreshNode {
	...
	/**
	 * Constructor needs two class name {@code Map}s, which are LoadingLayout
	 * class name map and Indicator class name {@code map}.<br />
	 * NOTE: Parameters must go in order. First Parameter : loading layout /
	 * Second Parameter : indicator layout
	 * 
	 * @param loadingLayoutClazzNameMap
	 *            LoadingLayout class names
	 * @param indicatorLayoutClazzNameMap
	 */
	public PullToRefreshNode(Map<String, String> loadingLayoutClazzNameMap,
			Map<String, String> indicatorLayoutClazzNameMap, Map<String, String> googleStyleViewLayoutClazzNameMap,
			Map<String, String> googleStyleProgressLayoutClazzNameMap) {
	...
	/**
	 * @param layoutCode
	 *            GoogleStyleViewLayout layout code
	...
	/**
	 * @param layoutCode
	 *            GoogleStyleProgressLayout layout code
	 ...
	 * 
	 * @param extendedNode
	 *            Other {@code PullToRefresNode} to be combined
	 */
