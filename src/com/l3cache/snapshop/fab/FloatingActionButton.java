package com.l3cache.snapshop.fab;
...
public class FloatingActionButton extends ImageButton {
	...
	void updateBackground() {
		...
		if (this.getClass().getSuperclass().equals(AddFloatingActionButton.class)) {
			layerDrawable.setLayerInset(3, iconInsetHorizontal, iconInsetTop, iconInsetHorizontal, iconInsetBottom);
		} else {
			layerDrawable.setLayerInset(3, (int) mShadowRadius, (int) circleTop, (int) mShadowRadius,
					(int) (mShadowRadius + mShadowOffset));
		}
