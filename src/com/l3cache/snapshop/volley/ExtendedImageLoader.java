...
public class ExtendedImageLoader extends ImageLoader {
	...
	public ExtendedImageLoader(RequestQueue queue, ImageCache imageCache) {
		this(queue, imageCache, new ImageRequestFactory() {
			...
			@Override
			public Request<?> getImageRequest(String url, Listener<Bitmap> listener, int maxWidth, int maxHeight,
					Config config, ErrorListener errorListener) {
	 ...
	 *            The cache to use as an L1 cache.
	 * @param factory
	 *            The factory for creating ImageRequests
	 */
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight) {
		...
		// network and
		// track it.
		Request<?> newRequest = mImageRequestFactory.getImageRequest(requestUrl, new Listener<Bitmap>() {
			@Override
